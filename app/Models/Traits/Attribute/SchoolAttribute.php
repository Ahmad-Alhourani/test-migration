...
trait SchoolAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.school.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" school="group" aria-label="School Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
