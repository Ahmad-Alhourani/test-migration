...
trait StudentAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.student.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" student="group" aria-label="Student Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
