...
trait AhmadAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.ahmad.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" ahmad="group" aria-label="Ahmad Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
